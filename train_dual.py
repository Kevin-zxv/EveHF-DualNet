...
train_file_pairs = [
    ("/root/autodl-tmp/labels/adacof25_60_6frame_labels.txt", "/root/autodl-tmp/labels/eventdacof25_60_6frame_labels.txt"),
    ("/root/autodl-tmp/labels/original_6frame_labels.txt", "/root/autodl-tmp/labels/eventoriginal_6frame_labels.txt"),
    # 添加更多文件对
]
...
testloader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=False,num_workers=10,pin_memory=True)  # 测试集不需要 shuffle
